...
import { CreateCampaign } from "@/types/authTypes";
import {
  Button,
  ColorPicker,
  NumberInput,
...
import { CreateCampaignValidation } from "@/validations/campaignValidations";
...
const CreateCampaignForm = () => {
  const form = useForm<CreateCampaign>({
    ...
    validate: yupResolver(CreateCampaignValidation),
  });

  const handleCreateSubmit = async (data: CreateCampaign) => {
    console.log(data);
  };
