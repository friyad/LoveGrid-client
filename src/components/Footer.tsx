...
const Footer = ({}: FooterProps) => {
  return (
    <HideComponentOn hiddenOn={["/login", "/signup", "/dashboard", "/user/"]}>
      <footer className="bg-gray-900 font-inter">
            ...
            <ul className="space-y-4 mt-8">
              <li>
                <svg
                  ...
                  className="inline-block w-4 h-4 fill-current text-white mr-4"
                  viewBox="0 0 24 24"
                >
                  <path
          ...
          <div>
            ...
            <form>
              <div className="flex">
                <input
                  type="email"
                  className="px-4 py-3.5 text-sm rounded-l-lg w-full focus:outline-none"
        ...
        <div className="bg-gray-800 py-5 px-4 text-center">
          <p className="text-gray-300 text-sm">
            © 2024 LoveGrid All Rights Reserved.
          </p>
        </div>
      </footer>
    </HideComponentOn>
