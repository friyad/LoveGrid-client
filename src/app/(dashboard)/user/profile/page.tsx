...
const ProfilePage = async () => {
  ...
  return (
    <div className="relative flex flex-col w-full break-words bg-clip-border max-w-4xl mx-auto pt-5">
        ...
        <div className="flex flex-wrap mb-6 xl:flex-nowrap ">
          ...
          <div className="grow">
            <div className="flex flex-wrap items-start justify-between mb-2">
              ...
              <div className="flex flex-wrap my-auto mb-3 md:mb-0">
      ...
      <div className="pt-5">
        <p className="text-sm xsm:text-base lg:text-lg text-gray-500">
